...
== Usage
  ...
  use Rack::GoogleAnalytics, :web_property_id => "UA-000000-0"
...
== Configuring for a Rails App
  ...
  config.middleware.use "Rack::GoogleAnalytics", :web_property_id => "UA-0000000-0"

== TODO and Motivations

This isn't very "feature rich", because I've mostly written it as an
excuse to learn more about rack. Hell, it's possibly someone has already done
